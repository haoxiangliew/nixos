{ stdenv, buildFHSUserEnvBubblewrap, writeShellScript, electron_19, lib, scrot
, ... }@args:
...
let
  ...
  resource = stdenv.mkDerivation rec {
    ...
    src = builtins.fetchurl {
      url =
        "https://home-store-packages.uniontech.com/appstore/pool/appstore/c/com.tencent.weixin/com.tencent.weixin_2.1.5_amd64.deb";
  ...
  fhs = buildFHSUserEnvBubblewrap {
    name = "wechat-uos";
    targetPkgs = pkgs: with pkgs; [ license openssl_1_1 resource ];
